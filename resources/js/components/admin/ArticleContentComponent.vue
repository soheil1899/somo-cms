            ...
            reloadPage() {
                ...
                axios.post('/dashboard/getarticlecontent', data)
                    .then(function (response) {
                        ...
                        that.articlename = response.data[0]['title'];
                        that.articleid = response.data[0]['id'];
                        that.articlegroup = response.data[0]['article_group_id'];
                        that.contentlist = response.data[0]['contents'];
                        that.filemanagerids = [];
                        try {
